...
const articles = [
  ...
  },
  {
    ...
    content:
      '{"time":1613784301531,"blocks":[{"type":"paragraph","data":{"text":"I wrote this text earlier!"}},{"type":"paragraph","data":{"text":"This is also from earlier, but in a separate block!"}}],"version":"2.19.1"}',
    category: 'project'
  },
  {
    title: 'Bacon',
